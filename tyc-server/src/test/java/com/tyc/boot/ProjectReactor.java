...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.tyc.boot";
    private static final String ARTIFACT_ID = "tyc";
    private static final String PACKAGE_NAME = "com.tyc.boot";
    private static final String TITLE = "脚手架";
    private static final String projectBaseDir = "E:\\javaProjects\\new\\tyc-spring-boot";
    private static final String projectBaseDirNew = "E:\\javaProjects\\new\\jiufang-spring-boot";
...
//        String projectBaseDir = getProjectBaseDir();
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.jiufang.boot";
        String artifactIdNew = "jiufang";
        String packageNameNew = "com.jiufang.boot";
        String titleNew = "脚手架";
